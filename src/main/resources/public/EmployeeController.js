var app = angular.module('demo', [])
    ...
    .controller('Employees', function ($scope, $http) {
        ...
        $scope.getEmployees = function () {
            $http.get($scope.urlService).then(function (response) {
        ...
        $scope.getEmployeeById = function (id) {
            $http.get($scope.urlService + "/" + id).then(function (response) {
        ...
        $scope.searchEmployees = function () {
            ...
            config.params[$scope.searchType] = $scope.searchText;

            $http.get($scope.urlService, config)
        ...
        $scope.advancedSearchEmployees = function () {
            var config = {
                params: {
                    lastName: $scope.lastNameText,
                    title: $scope.titleText,
                    department: $scope.departmentText
                }
            };
